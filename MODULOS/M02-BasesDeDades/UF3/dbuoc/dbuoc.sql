...
CREATE TABLE IF NOT EXISTS dbuoc.projectes 
  (codi_proj TINYINT PRIMARY KEY,
   ...
   data_fi DATE, 
   codi_client TINYINT,
   cost_proj tinyint default 0,
   nombre_treballadors tinyint default 0,
...
create table if not exists dbuoc.projectesfinalitzats
(
nom_projecte char(20) ,
estat_fin enum("SI","NO") default "NO"
);
...
VALUES (1,'GESCOM',600000.00, '2004-1-1', '2005-1-1', NULL, 10, 0, 0);

INSERT INTO dbuoc.projectes
VALUES (2,'PESCI',1200000.00, '2002-1-1', '2004-5-31', '2004-5-1', 10, 0, 0);

INSERT INTO dbuoc.projectes
VALUES (3,'SALSA',600000.00, '2004-2-10', '2005-1-2', NULL, 20, 0, 0);

INSERT INTO dbuoc.projectes
VALUES (4,'TINELL',2400000.00, '2003-1-1', '2005-1-12', NULL, 20, 0, 0);
